...
if CLIENT then
   ...
   SWEP.Icon = "VGUI/hys/icon_knife"
end

--SWEP.Base               = "weapon_hysbase"
SWEP.AllowDrop			= true
SWEP.UseHands			= false
SWEP.ViewModelFlip		= false
...
function SWEP:SecondaryAttack()
   ...
   if SERVER then
      ...
      knife_ang:RotateAroundAxis(knife_ang:Right(), -45)
...
if CLIENT then
   function SWEP:DrawHUD()
      ...
      return 0 --self.BaseClass.DrawHUD(self)
   end
end
