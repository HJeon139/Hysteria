...
extern HRESULT CALLBACK OnD3D10CreateDevice( ID3D10Device* pd3dDevice, const DXGI_SURFACE_DESC* pBackBufferSurfaceDesc,
                                             void* pUserContext );
extern HRESULT CALLBACK OnD3D10ResizedSwapChain( ID3D10Device* pd3dDevice, IDXGISwapChain* pSwapChain,
                                                 const DXGI_SURFACE_DESC* pBackBufferSurfaceDesc, void* pUserContext );
extern void CALLBACK OnD3D10ReleasingSwapChain( void* pUserContext );
...
int WINAPI wWinMain( HINSTANCE hInstance, HINSTANCE hPrevInstance, LPWSTR lpCmdLine, int nCmdShow )
{
    ...
    InitApp();
#if 1 // Force use of ref for SM 5.0
                                  ...
                                  float fElapsedTime, void* pUserContext )
{
    ...
    // Restore default Rasterizer State for the UI?
//    pd3dImmediateContext->RSSetState( g_pRasterizerStateSolid );
