...
HRESULT CreateDDSTextureFromFile( ID3D10Device* pDev, WCHAR* szFileName, ID3D10ShaderResourceView** ppSRV,
                                  bool bSRGB );
HRESULT CreateDDSTextureFromFile( ID3D11Device* pDev, WCHAR* szFileName, ID3D11ShaderResourceView** ppSRV,
                                  bool bSRGB );
...
HRESULT CreateTextureFromDDS( ID3D11Device* pDev, DDSURFACEDESC2_32BIT* pSurfDesc, BYTE* pBitData, UINT BitSize,
                              ID3D11ShaderResourceView** ppSRV, bool bSRGB, bool bSwizzle = true );