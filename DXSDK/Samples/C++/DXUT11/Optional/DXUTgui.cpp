...
void CDXUTDialogResourceManager::EndSprites11( ID3D11Device* pd3dDevice, ID3D11DeviceContext* pd3dImmediateContext )
{
    ...
    destRegion.front = 0;
    destRegion.back = 1;
    pd3dImmediateContext->UpdateSubresource( m_pSpriteBuffer11, 0, &destRegion, (void*)m_SpriteVertices.GetData(), 0, 0 );
...
void EndText11( ID3D11Device* pd3dDevice, ID3D11DeviceContext* pd3d11DeviceContext )
{
    ...
    destRegion.front = 0;
    destRegion.back = 1;
    pd3d11DeviceContext->UpdateSubresource( g_pFontBuffer11, 0, &destRegion, (void*)g_FontVertices.GetData(), 0, 0 );
